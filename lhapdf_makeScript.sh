...
echo >> lhapdf_makeLinks.file
#
echo "export cvmfspath=/tmp/lhapdf/pdfsets/%1" >> lhapdf_makeLinks.file
export ss=`ls /tmp/lhapdf/pdfsets/$1`
...
cp -f /tmp/lhapdf/pdfsets/$1/pdfsets.index lhapdf_pdfsetsindex.file
